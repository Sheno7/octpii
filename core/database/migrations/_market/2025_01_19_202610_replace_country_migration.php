...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("
            CREATE FOREIGN TABLE IF NOT EXISTS countries (
                id BIGSERIAL,
                title_ar VARCHAR(255) NOT NULL,
                title_en VARCHAR(255) NOT NULL,
                code VARCHAR(255) NOT NULL, -- Phone code
                flag VARCHAR(255) NOT NULL,
                currency VARCHAR(255) NOT NULL,
                isocode VARCHAR(255) NOT NULL, -- ISO code
    ...
    {
        DB::statement('DROP FOREIGN TABLE IF EXISTS countries;');

        // Optionally drop the server and user mapping
