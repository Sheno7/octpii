...
class MaSettingsController extends Controller {
    use DayTrait, ResponseTrait;

    public function get_working_schedule() {
        // Retrieve working schedule from the database for the market
        $marketWorkingSchedule = WorkingSchedule::whereNull('provider_id')->get();
        ...
        foreach ($marketWorkingSchedule as $workingDay) {
